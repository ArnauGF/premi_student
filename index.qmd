...
<div style="position:absolute; top:50%; left:0%;" class="fragment fade-in-then-out">
  - We assume 
...
<div style="position:absolute; top:50%; left:0%;" class="fragment fade-in">
  - [Conditional independence]{style="color:#00BFFF;"} is assumed 
</div>

<div style="position:absolute; top:62%; left:41%;" class="fragment fade-in-then-out">
  $$
  \large\require{color}
...
<div style="position:absolute; top:62%; left:38%" class="fragment fade-in-then-out">
  $$
  \large\require{color}
...
<div style="position:absolute; top:62%; left:18%;" class="fragment fade-in-then-out">
  $$
  \large\require{color}
...
<div style="position:absolute; top:63%; left:0%;" class="fragment fade-in-then-out">
